...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1 class="fw-bold" style="color: var(--text-main);">🎯 My Watchlist</h1>
...
<?php if (empty($movies)): ?>
    <div class="text-center py-5">
        <p style="color: var(--text-muted);" class="fs-5">Your watchlist is empty.</p>
...
<?php else: ?>
    <div class="row" id="watchlistGrid">
        ...
        <div class="col-md-3 col-sm-6 mb-4" id="movie-<?= $movie['movie_id'] ?>">
            <div class="card border-0 shadow h-100 movie-card-hover">
                ...
                <div class="card-body d-flex flex-column">
                    <h5 class="card-title" style="color: var(--text-main);"><?= esc($movie['title']) ?></h5>
                    <p style="color: var(--text-muted);" class="small">
                        <?= substr($movie['release_date'] ?? '', 0, 4) ?>
                        <?php if (!empty($movie['genres'])): ?>
                            · <?= esc(implode(', ', array_column(array_slice($movie['genres'], 0, 2), 'name'))) ?>
                        <?php endif; ?>
                    </p>
                    ...
                    <div class="mt-auto d-flex gap-2">
                        <a href="<?= base_url('movie/detail/' . $movie['movie_id']) ?>"
                           class="btn btn-outline-warning btn-sm flex-grow-1">View</a>
